...
class StudioJourneyTests(TestCase):
    ...
    def test_complete_synthetic_sandbox_vertical_slice(self) -> None:
        ...
        self.assertContains(evaluation_response, "Four requests, four recorded decisions")
        self.assertContains(evaluation_response, "Calls 1–3 · permitted")
        self.assertContains(evaluation_response, "Call 4 · denied")
        self.assertContains(evaluation_response, "No content returned.")
        self.assertContains(evaluation_response, "cited findings above")
